[![nginx 1.24.0](https://img.shields.io/badge/nginx-1.24.0-brightgreen.svg?&logo=nginx&logoColor=white&style=for-the-badge)](https://nginx.org/en/CHANGES) 
...
|-----|-------|-----|--------|--------|------|
| latest | master Branch | 1.24.0 | 8.2.8 | bookworm | 2.5.8 |
